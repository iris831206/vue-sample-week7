          ...
          <div class="row py-3">
              ...
              <div class="col-md-6">
                  ...
                  <div v-if="tempProduct.title">
                    <div class="card mb-3" >
                      <img v-bind:src="tempProduct.imageUrl" height="300" class="card-img-top primary-image" style="object-fit:cover" alt="主圖">
                      <div class="card-body">
                        <h5 class="card-title">
                          {{ tempProduct.title }}
                    ...
                    <span v-for="(image, id) in tempProduct.imagesUrl" v-bind:key="id">
                      <img v-if="image" v-bind:src="image" class="images m-2" style="object-fit:cover" height="300">
                    </span>
                  </div>
